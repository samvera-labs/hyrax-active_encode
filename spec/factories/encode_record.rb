...
FactoryBot.define do
  factory :encode_record, class: ActiveEncode::EncodeRecord do
    ...
    create_options { "{\"outputs\":[{\"label\":\"high\",\"extension\":\"mp4\",\"ffmpeg_opt\":\"-ac 2 -ab 192k -ar 44100 -acodec aac\"},{\"label\":\"medium\",\"extension\":\"mp4\",\"ffmpeg_opt\":\"-ac 2 -ab 128k -ar 44100 -acodec aac\"}],\"file_set_id\":\"6q182k13s\",\"work_id\":\"6q182k12h\",\"work_type\":\"AudiovisualWork\",\"local_streaming\":true}" }
    progress { 100 }
    work_id { '6q182k12h' }
    work_type { 'AudiovisualWork' }
    file_set { '6q182k13s' }
    sequence(:display_title) { |n| "Title #{1000 - n}" }
  end
end
